      ...
      <div>
        ...
        <PageSection fullWidth={false} title="Impressum">
          <div className={['textRow', impressumStyles.wrapper].join(' ')}>
            ...
            <p>
              Deutsch-Jemenitischer Verein für Hilfe und Entwicklung e.V.
              <br /> Drontheimer Str. 32A
              <br /> 13359 Berlin
            </p>
            <h3>Vertreten durch:</h3>
            <p>
              Herr Dr. Aniss Aldoaiss
              <br /> Herr Dr. Ahmed Al-Khameri
            </p>
            <h3>Kontakt:</h3>
            <p>
              Telefon: +49 (0) 176 341 263 24
              <br /> E-Mail: info@djv-hilfe.de
            </p>
            <h3>Registereintrag:</h3>
            <p>
              Eintragung im Vereinsregister. <br /> Registergericht: Amtsgericht Berlin <br /> Registernummer: HRB 999999
            </p>
            <h3> Haftung fürr Inhalte</h3>
            <p>
              Als Diensteanbieter sind wir gemäß &sect; 7 Abs.1 TMG für eigene Inhalte auf diesen Seiten nach den allgemeinen Gesetzen
              verantwortlich. Nach &sect;&sect; 8 bis 10 TMG sind wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte oder
