export const Paypal = [
  ...
  },
  {
    ...
    title: 'Eid Geschenke',
    subTitle: 'Beende deinen Ramadan mit einer guten Tat',
    text: 'Es ist eine Tradition, zum Ende des Ramadans, den Armen und Bedürftigen Geschenke zu geben. Das ist dafür gedacht, dass alle an der Freude des Eids teilnehmen können.',
    type: 'active',
    tags: ['ramadan'],
  ...
  },
  {
    ...
    text: 'Während des Monats Ramadan fasten Muslime um Allah näher zu kommen. Für viele Menschen ist das Normalität, da sie nicht genug zu Essen haben. Mit Ihrer Spende können wir sicherstellen, dass Bedürftige am Ende des Fastentages ihr Fasten brechen können.',
    type: 'active',
    tags: ['ramadan'],
    image: '/assets/Lebensmittelpakete.jpeg',
  },
  ...
  },
  {
    ...
    text: 'Die Sühne ist eine der regelmäßigen Gründe warum gespendet wird. Sie soll an Arme und Bedürftige ausgegeben werden um für einen nicht eingehaltenen Eid oder Schwur zu sühnen. Eine solche Tat geschieht sehr oft und ist keine Schande, sollte aber schnell erledigt werden.\n\nWir verwenden die Spenden für verschiedene Projekte um die Bedürftigen zu ernähren und zu unterstützen. Besser kann Ihre Sühne nicht eingesetzt werden.',
    type: 'permanent',
    tags: [],
  ...
  },
  {
    ...
    text: 'Jährlich zum Opferfest, welches direkt nach der Pilgerfahrt stattfindet, sind Muslime dazu verpflichtet ein Opfer (Kurban) zu bringen. Dies wird als Erinnerung an die Geschichte von Abraham und Ismail gemacht. Dieses Opfer soll mindestens zu einem Drittel an Bedürftige verteilt werden.\n\nWenn Sie Ihr Kurban für die Menschen im Jemen geben wollen, spenden Sie an uns und setzen Sie sich mit uns in Verbindung. Wir haben Partner vor Ort, die bereit sind so viele Menschen, wie möglich mit Fleisch zu versorgen.\n\nSpenden Sie jetzt!',
    type: 'permanent',
    tags: [],
